                ...
                <div className="p-6 border-b dark:border-slate-800 flex flex-col md:flex-row gap-4 justify-between">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="pl-10 pr-4 py-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-transparent text-sm w-full md:w-64 focus:ring-2 focus:ring-blue-500 outline-none transition-all"
                        />
                    </div>
                </div>
